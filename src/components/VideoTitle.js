...
const VideoTitle = ({ title, description }) => {
  return (
    <div className=" pt-[25%] [sm:pt-[28%] md:pt-[18%] px-10 absolute text-white bg-gradient-to-r from-black w-full aspect-video">
      <h1 className="md:text-5xl text-sm sm:text-2xl font-bold">{title}</h1>
